...
def start_new_game(word_list, answer_word=None):
    ...
    if answer_word == None:
        new_game_dict['answer_word'] = _get_random_word(word_list)
    else:
        new_game_dict['answer_word'] = answer_word
         
    new_game_dict['masked_word'] = _mask_word(new_game_dict['answer_word'])
