...
https://www.codecademy.com/en/forum_questions/5087f2d786a27b02000041a9  <-- This might also explain it good



mylist = ['Josh', 'Viet', 'Manny', 'Santiago', 'Martin']
>>> for num, v in enumerate(mylist):
    print(num, val)
